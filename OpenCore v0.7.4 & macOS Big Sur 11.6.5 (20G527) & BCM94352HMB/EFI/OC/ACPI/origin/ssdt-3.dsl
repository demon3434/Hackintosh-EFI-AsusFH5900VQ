 ...
 *
 * Disassembly of ssdt-3.aml, Sun Oct 10 08:22:17 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003D6E (15726)
 *     Revision         0x02
 *     Checksum         0x92
 *     OEM ID           "DptfTa"
 ...
 */
DefinitionBlock ("ssdt-3.aml", "SSDT", 2, "DptfTa", "DptfTabl", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.B0D4)
    {
        ...
        Method (CPL1, 0, NotSerialized)
        {
            Store (0x02, Index (\_SB.PCI0.B0D4.NPCC, Zero))
            Store (Zero, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), Zero))
            Store (0x9C40, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), One))
